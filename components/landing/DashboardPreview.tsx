            ...
            <div className="flex">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="bg-white border-b border-slate-200 px-3 py-2 md:px-4 md:py-3 flex items-center justify-between">
                        <div className="flex items-center gap-2 text-xs text-slate-500 bg-slate-50 px-2 py-1 rounded border border-slate-200">
                        ...
                        <div className="flex items-center gap-2 md:gap-4 text-slate-400">
                            ...
                            <div className="flex items-center gap-1 md:gap-2">
                                <div className="text-right hidden sm:block">
                                    <div className="text-[10px] md:text-xs font-bold text-slate-900">AutoTeile Müller GmbH</div>
                    ...
                    <div className="bg-slate-50 p-3 md:p-4 lg:p-6">
                        <div className="mb-3 md:mb-4">
                            <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-slate-900 mb-0.5">Heute</h2>
                            <p className="text-slate-500 text-xs md:text-sm hidden sm:block">Dein aktueller Arbeitsstand aus WhatsApp, Angeboten und Aufträgen</p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 md:gap-3 mb-3 md:mb-4">
                            ...
                            <div className="bg-white p-2 md:p-3 lg:p-4 rounded-lg border border-slate-200 shadow-sm">
                                <div className="flex items-center gap-2 mb-1 md:mb-2">
                                    ...
                                    <span className="text-[10px] md:text-xs text-slate-600 truncate">WhatsApp</span>
                                </div>
                                <div className="text-lg md:text-2xl font-bold text-slate-900">3</div>
                                <div className="text-[8px] md:text-[10px] text-emerald-600 hidden sm:block">+12% vs. gestern</div>
                            </div>
                            ...
                            <div className="bg-white p-2 md:p-3 lg:p-4 rounded-lg border border-slate-200 shadow-sm">
                                <div className="flex items-center gap-2 mb-1 md:mb-2">
                                    ...
                                    <span className="text-[10px] md:text-xs text-slate-600 truncate">Bearbeitung</span>
                                </div>
                                <div className="text-lg md:text-2xl font-bold text-slate-900">6</div>
                                <div className="text-[8px] md:text-[10px] text-emerald-600 hidden sm:block">+2.3% vs. Woche</div>
                            </div>

                            {/* Card 3: Offene Belege */}
                            <div className="bg-white p-2 md:p-3 lg:p-4 rounded-lg border border-slate-200 shadow-sm">
                                <div className="flex items-center gap-2 mb-1 md:mb-2">
                                    <div className="p-1 md:p-1.5 bg-rose-50 text-rose-600 rounded">
                            ...
                            {/* Card 4: Umsatz */}
                            <div className="bg-white p-2 md:p-3 lg:p-4 rounded-lg border border-slate-200 border-l-2 border-l-blue-500 shadow-sm">
                                <div className="mb-1 md:mb-2">
                                    <span className="text-[10px] md:text-xs text-slate-600">Umsatz</span>
                                </div>
                                <div className="text-sm md:text-xl lg:text-2xl font-bold text-slate-900">€1.250</div>
                                <div className="text-[8px] md:text-[10px] text-emerald-600 hidden sm:block">+18% vs. gestern</div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-2 md:gap-3">
                            {/* Chart Section */}
                            <div className="lg:col-span-2 bg-white p-2 md:p-3 lg:p-4 rounded-lg border border-slate-200 shadow-sm">
                                <div className="flex items-center justify-between mb-2 md:mb-3">
                                    <div>
                                        <h3 className="text-sm md:text-base font-bold text-slate-900">Umsatz</h3>
                                        <p className="text-[10px] md:text-xs text-slate-500">Letzte 30 Tage</p>
                                    </div>
                                    <div className="hidden md:flex gap-0.5 bg-slate-100 rounded p-0.5">
                                        <button className="text-[10px] font-medium px-1.5 py-0.5 rounded text-slate-500">7T</button>
                                        <button className="text-[10px] font-medium bg-white px-1.5 py-0.5 rounded text-slate-900 shadow-sm">30T</button>
                                ...
                                <div className="h-[80px] md:h-[100px] lg:h-[120px] w-full">
                                    <ResponsiveContainer width="100%" height="100%">
                                        <AreaChart data={chartData}>
                                            ...
                                            <YAxis axisLine={false} tickLine={false} tick={{ fontSize: 9, fill: '#94a3b8' }} tickFormatter={(value) => `€${value}`} dx={-5} width={35} />
                            ...
                            <div className="bg-white p-2 md:p-3 lg:p-4 rounded-lg border border-slate-200 shadow-sm">
                                <div className="flex items-center justify-between mb-2">
                                    <div>
                                        <h3 className="text-sm md:text-base font-bold text-slate-900">Top Kunden</h3>
                                        <p className="text-[10px] md:text-xs text-slate-500">Diese Woche</p>
                                    </div>
                                    <TrendingUp className="h-3 w-3 md:h-4 md:w-4 text-slate-400" />
                                </div>
