                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="bg-slate-800/80 border-b border-slate-700/50 px-3 py-2 md:px-4 md:py-3 flex items-center justify-between">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="hidden sm:flex items-center gap-2 text-xs text-slate-400 bg-slate-700/50 px-2 py-1 rounded border border-slate-600/50">
                        ...
                        <div className="flex items-center gap-2 md:gap-4 text-slate-500">
                            ...
                            <div className="flex items-center gap-1 md:gap-2">
                                <div className="text-right hidden sm:block">
                                    <div className="text-[10px] md:text-xs font-bold text-slate-200">AutoTeile Müller</div>
                    ...
                    <div className="bg-slate-800/30 p-3 md:p-4 lg:p-6">
                        {/* Header */}
                        <div className="mb-1">
                            <span className="text-[10px] md:text-xs font-medium text-blue-400 uppercase tracking-wider">WAWI WORKSPACE</span>
                        </div>
                        <div className="mb-3 md:mb-4">
                            <h2 className="text-lg md:text-xl lg:text-2xl font-bold text-white mb-0.5">Bestandsübersicht</h2>
                            <p className="text-slate-400 text-xs md:text-sm hidden sm:block">Alle Lagerprozesse und Artikelkennzahlen auf einen Blick.</p>
                        </div>
                        ...
                        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 md:gap-3 mb-3 md:mb-4">
                            ...
                            <div className="bg-slate-800/60 p-2 md:p-3 lg:p-4 rounded-lg border border-slate-700/50 shadow-lg backdrop-blur-sm">
                                <div className="flex items-center gap-2 mb-1 md:mb-2">
                                    <div className="p-1 md:p-1.5 bg-slate-600/50 text-slate-300 rounded">
                                        <Package className="h-3 w-3 md:h-4 md:w-4" />
                                    </div>
                                    <span className="text-[10px] md:text-xs text-slate-400 truncate">Artikel</span>
                                </div>
                                <div className="text-lg md:text-2xl font-bold text-white">22</div>
                            </div>

                            {/* Card 2: Kritischer Bestand */}
                            <div className="bg-slate-800/60 p-2 md:p-3 lg:p-4 rounded-lg border border-amber-500/30 border-l-2 border-l-amber-500 shadow-lg backdrop-blur-sm">
                                <div className="flex items-center gap-2 mb-1 md:mb-2">
                                    <div className="p-1 md:p-1.5 bg-amber-500/20 text-amber-400 rounded">
                                        <AlertTriangle className="h-3 w-3 md:h-4 md:w-4" />
                                    </div>
                                    <span className="text-[10px] md:text-xs text-slate-400 truncate">Kritisch</span>
                                </div>
                                <div className="text-lg md:text-2xl font-bold text-white">2</div>
                            </div>
                            ...
                            <div className="bg-slate-800/60 p-2 md:p-3 lg:p-4 rounded-lg border border-slate-700/50 shadow-lg backdrop-blur-sm">
                                <div className="flex items-center gap-2 mb-1 md:mb-2">
                                    <div className="p-1 md:p-1.5 bg-emerald-500/20 text-emerald-400 rounded">
                                        <TrendingUp className="h-3 w-3 md:h-4 md:w-4" />
                                    </div>
                                    <span className="text-[10px] md:text-xs text-slate-400 truncate">Lagerwert</span>
                                </div>
                                <div className="text-lg md:text-2xl font-bold text-white">0 €</div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 md:gap-3">
                            ...
                            <div className="bg-slate-800/60 p-2 md:p-3 lg:p-4 rounded-lg border border-slate-700/50 shadow-lg backdrop-blur-sm">
                                <div className="flex items-center justify-between mb-2 md:mb-3">
                                    <div className="flex items-center gap-1 md:gap-2">
                                        ...
                                        <h3 className="text-sm md:text-base font-bold text-white">Kritische Bestände</h3>
                                    </div>
                                    <button className="text-[10px] md:text-xs text-blue-400">
                                        <span className="hidden sm:inline">Alle ansehen</span> →
                                    </button>
                                </div>
                                <div className="space-y-2">
                                    <div className="flex items-center justify-between py-1 md:py-2 border-b border-slate-700/50">
                                        <div>
                                            <div className="font-medium text-white text-xs md:text-sm">Bremssattel vorne</div>
                                            <div className="text-[10px] text-slate-500">8K0615123F</div>
                                        </div>
                                        <div className="text-right">
                                            <div className="font-bold text-rose-400 text-xs md:text-sm">4 Stk</div>
                                            <div className="text-[10px] text-slate-500">Min: 5</div>
                                        </div>
                                    </div>
                                    <div className="flex items-center justify-between py-1 md:py-2">
                                        <div>
                                            <div className="font-medium text-white text-xs md:text-sm">Turbolader Garrett</div>
                                            <div className="text-[10px] text-slate-500">03L2538161X</div>
                                        </div>
                                        <div className="text-right">
                                            <div className="font-bold text-rose-400 text-xs md:text-sm">2 Stk</div>
                                            <div className="text-[10px] text-slate-500">Min: 5</div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="bg-slate-800/60 p-2 md:p-3 lg:p-4 rounded-lg border border-slate-700/50 shadow-lg backdrop-blur-sm">
                                <div className="flex items-center gap-1 md:gap-2 mb-2 md:mb-3">
                                    <History className="h-3 w-3 md:h-4 md:w-4 text-slate-500" />
                                    <h3 className="text-sm md:text-base font-bold text-white">Letzte Bewegungen</h3>
                                </div>
                                <div className="flex flex-col items-center justify-center py-4 md:py-6 text-slate-500">
                                    <History className="h-6 w-6 md:h-8 md:w-8 mb-2 text-slate-600" />
